...
#  ]
constraints_assign8 = [('ptheta_pll_averaged','pRPLL_PI_averaged',1)]
constraints_combi8 = []
...
inputs12 = ['DFIG_Lx_total', 'DFIG_Ly_total', 'infL_x', 'infL_y', 'HVDC_Lx_left', 'HVDC_Ly_left']  #, 'HVDC_Lx1', 'HVDC_Ly1'
